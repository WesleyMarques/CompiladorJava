...
{ before(grammarAccess.getStatementAccess().getNameStatementIDTerminalRuleCall_7_0_0()); }
	RULE_ID{ after(grammarAccess.getStatementAccess().getNameStatementIDTerminalRuleCall_7_0_0()); }
)
...
{ before(grammarAccess.getStatementAccess().getStatementStatementParserRuleCall_7_2_0()); }
	ruleStatement{ after(grammarAccess.getStatementAccess().getStatementStatementParserRuleCall_7_2_0()); }
)
...
{ before(grammarAccess.getStatementAccess().getSyncStatementStatementParserRuleCall_8_3_0()); }
	ruleStatement{ after(grammarAccess.getStatementAccess().getSyncStatementStatementParserRuleCall_8_3_0()); }
)
