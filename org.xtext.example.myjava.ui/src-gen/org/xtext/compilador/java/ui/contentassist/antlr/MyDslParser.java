		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStatementAccess().getSyncStatementAssignment_6_3(), "rule__Statement__SyncStatementAssignment_6_3");
					put(grammarAccess.getStatementAccess().getNameStatementAssignment_9_0(), "rule__Statement__NameStatementAssignment_9_0");
