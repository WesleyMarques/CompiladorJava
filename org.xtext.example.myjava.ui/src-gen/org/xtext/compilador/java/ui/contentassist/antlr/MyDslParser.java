		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStatementAccess().getTryStatementAssignment_6(), "rule__Statement__TryStatementAssignment_6");
					put(grammarAccess.getStatementAccess().getNameStatementAssignment_7_0(), "rule__Statement__NameStatementAssignment_7_0");
					put(grammarAccess.getStatementAccess().getStatementAssignment_7_2(), "rule__Statement__StatementAssignment_7_2");
					put(grammarAccess.getStatementAccess().getSyncStatementAssignment_8_3(), "rule__Statement__SyncStatementAssignment_8_3");
