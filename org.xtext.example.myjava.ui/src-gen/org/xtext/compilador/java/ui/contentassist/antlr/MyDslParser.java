		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStatementAccess().getTryStatementAssignment_5(), "rule__Statement__TryStatementAssignment_5");
					...
					put(grammarAccess.getStatementAccess().getNameStatementAssignment_10_0(), "rule__Statement__NameStatementAssignment_10_0");
