...
public class MyDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Statement_SemicolonKeyword_13_1_or___BreakKeyword_11_1_SemicolonKeyword_11_3___or___ContinueKeyword_12_1_SemicolonKeyword_12_3___or___ReturnKeyword_9_1_SemicolonKeyword_9_2___or___ThrowKeyword_10_1_SemicolonKeyword_10_2__;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Statement_SemicolonKeyword_13_1_or___BreakKeyword_11_1_SemicolonKeyword_11_3___or___ContinueKeyword_12_1_SemicolonKeyword_12_3___or___ReturnKeyword_9_1_SemicolonKeyword_9_2___or___ThrowKeyword_10_1_SemicolonKeyword_10_2__ = new AlternativeAlias(false, false, new GroupAlias(false, false, new TokenAlias(false, false, grammarAccess.getStatementAccess().getBreakKeyword_11_1()), new TokenAlias(false, false, grammarAccess.getStatementAccess().getSemicolonKeyword_11_3())), new GroupAlias(false, false, new TokenAlias(false, false, grammarAccess.getStatementAccess().getContinueKeyword_12_1()), new TokenAlias(false, false, grammarAccess.getStatementAccess().getSemicolonKeyword_12_3())), new GroupAlias(false, false, new TokenAlias(false, false, grammarAccess.getStatementAccess().getReturnKeyword_9_1()), new TokenAlias(false, false, grammarAccess.getStatementAccess().getSemicolonKeyword_9_2())), new GroupAlias(false, false, new TokenAlias(false, false, grammarAccess.getStatementAccess().getThrowKeyword_10_1()), new TokenAlias(false, false, grammarAccess.getStatementAccess().getSemicolonKeyword_10_2())), new TokenAlias(false, false, grammarAccess.getStatementAccess().getSemicolonKeyword_13_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_Statement_SemicolonKeyword_13_1_or___BreakKeyword_11_1_SemicolonKeyword_11_3___or___ContinueKeyword_12_1_SemicolonKeyword_12_3___or___ReturnKeyword_9_1_SemicolonKeyword_9_2___or___ThrowKeyword_10_1_SemicolonKeyword_10_2__.equals(syntax))
				emit_Statement_SemicolonKeyword_13_1_or___BreakKeyword_11_1_SemicolonKeyword_11_3___or___ContinueKeyword_12_1_SemicolonKeyword_12_3___or___ReturnKeyword_9_1_SemicolonKeyword_9_2___or___ThrowKeyword_10_1_SemicolonKeyword_10_2__(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     nameMethod=ID '(' ')' (ambiguity) debug=';'
	 *     nameMethod=ID '(' ')' (ambiguity) statementMethod=Statement_block
	 *     parameterListMethod=Parameter_list ')' (ambiguity) debug=';'
	 ...
	 */
	protected void emit_Statement_SemicolonKeyword_13_1_or___BreakKeyword_11_1_SemicolonKeyword_11_3___or___ContinueKeyword_12_1_SemicolonKeyword_12_3___or___ReturnKeyword_9_1_SemicolonKeyword_9_2___or___ThrowKeyword_10_1_SemicolonKeyword_10_2__(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
