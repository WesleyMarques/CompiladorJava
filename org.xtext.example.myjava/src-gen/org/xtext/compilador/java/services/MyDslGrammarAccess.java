...
public class MyDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class StatementElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cStatement_blockParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		private final Assignment cTryStatementAssignment_6 = (Assignment)cAlternatives.eContents().get(6);
		private final RuleCall cTryStatementTry_statementParserRuleCall_6_0 = (RuleCall)cTryStatementAssignment_6.eContents().get(0);
		private final Group cGroup_7 = (Group)cAlternatives.eContents().get(7);
		private final Assignment cNameStatementAssignment_7_0 = (Assignment)cGroup_7.eContents().get(0);
		private final RuleCall cNameStatementIDTerminalRuleCall_7_0_0 = (RuleCall)cNameStatementAssignment_7_0.eContents().get(0);
		...
		private final Keyword cSynchronizedKeyword_8_1 = (Keyword)cGroup_8.eContents().get(1);
		private final Keyword cRightParenthesisKeyword_8_2 = (Keyword)cGroup_8.eContents().get(2);
		private final Assignment cSyncStatementAssignment_8_3 = (Assignment)cGroup_8.eContents().get(3);
		private final RuleCall cSyncStatementStatementParserRuleCall_8_3_0 = (RuleCall)cSyncStatementAssignment_8_3.eContents().get(0);
		...
		private final Keyword cThrowKeyword_10_1 = (Keyword)cGroup_10.eContents().get(1);
		...
		//Statement:
		//	variableDeclaration=Variable_declaration | //expressionStatement = Expression ";" |
		//	ifStatement=If_statement | doStatement=Do_Statement | whileStatement=While_Statement | forStatement=For_Statement | //switchStatement = Switch_statement |
		//	Statement_block | tryStatement=Try_statement | nameStatement=ID ":" statement=Statement | {Statement} "synchronized("
		//	/ *Expression * / ")" syncStatement=Statement | {Statement} "return" / *(Expression)? * / ";" | {Statement} "throw"
		//	/ *(Expression)? * / ";" | {Statement} "break" name=ID? ";" | {Statement} "continue" name=ID? ";" | {Statement} ";";
		@Override public ParserRule getRule() { return rule; }
		...
		public Assignment getTryStatementAssignment_6() { return cTryStatementAssignment_6; }

		//Try_statement
		public RuleCall getTryStatementTry_statementParserRuleCall_6_0() { return cTryStatementTry_statementParserRuleCall_6_0; }

		//nameStatement=ID ":" statement=Statement
		public Group getGroup_7() { return cGroup_7; }

		//nameStatement=ID
		public Assignment getNameStatementAssignment_7_0() { return cNameStatementAssignment_7_0; }

		//ID
		public RuleCall getNameStatementIDTerminalRuleCall_7_0_0() { return cNameStatementIDTerminalRuleCall_7_0_0; }
		...
		//"synchronized("
		public Keyword getSynchronizedKeyword_8_1() { return cSynchronizedKeyword_8_1; }

		/// *Expression * / ")"
		public Keyword getRightParenthesisKeyword_8_2() { return cRightParenthesisKeyword_8_2; }

		//syncStatement=Statement
		public Assignment getSyncStatementAssignment_8_3() { return cSyncStatementAssignment_8_3; }

		//Statement
		public RuleCall getSyncStatementStatementParserRuleCall_8_3_0() { return cSyncStatementStatementParserRuleCall_8_3_0; }
		...
		//"throw"
		public Keyword getThrowKeyword_10_1() { return cThrowKeyword_10_1; }
	...
	public class For_StatementElements extends AbstractParserRuleElementFinder {
		...
		// //Switch_statement:
		//
		////	{Switch_statement}"switch("/ *Expression * /"){" (("case" / *Expression * / ":") | ("default:") | (statements += Statement))*"}"
		// //;
		//For_Statement:
