 ...
 * <ul>
 *   <li>{@link org.xtext.compilador.java.myDsl.impl.StatementImpl#getStatments <em>Statments</em>}</li>
 ...
 * @generated
 */
public class StatementImpl extends Statement_blockImpl implements Statement
{
  /**
  ...
  public EList<Statement> getStatments()
  {
    if (statments == null)
    {
      statments = new EObjectContainmentEList<Statement>(Statement.class, this, MyDslPackage.STATEMENT__STATMENTS);
    }
    return statments;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.STATEMENT__STATMENTS:
