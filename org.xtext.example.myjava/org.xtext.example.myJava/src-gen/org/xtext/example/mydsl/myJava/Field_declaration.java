 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.Field_declaration#getComment <em>Comment</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Field_declaration#getVariableDeclaration <em>Variable Declaration</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Field_declaration#getContructorName <em>Contructor Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Field_declaration#getMethodName <em>Method Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Field_declaration#getStaticinitializer <em>Staticinitializer</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getField_declaration()
 * @model
 * @generated
 */
public interface Field_declaration extends EObject
{
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getField_declaration_Comment()
   * @model
   * @generated
   */
  String getComment();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Field_declaration#getComment <em>Comment</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getField_declaration_VariableDeclaration()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Field_declaration#getVariableDeclaration <em>Variable Declaration</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getField_declaration_ContructorName()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Field_declaration#getContructorName <em>Contructor Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getField_declaration_MethodName()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Field_declaration#getMethodName <em>Method Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getField_declaration_Staticinitializer()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Field_declaration#getStaticinitializer <em>Staticinitializer</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
