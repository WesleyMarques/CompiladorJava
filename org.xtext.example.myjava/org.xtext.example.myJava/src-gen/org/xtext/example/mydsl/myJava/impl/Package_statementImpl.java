 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Package_statementImpl#getPacName <em>Pac Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Package_statementImpl extends MinimalEObjectImpl.Container implements Package_statement
{
  ...
  {
    return MyJavaPackage.Literals.PACKAGE_STATEMENT;
  }
  ...
  public void setPacName(String newPacName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.PACKAGE_STATEMENT__PAC_NAME, oldPacName, pacName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyJavaPackage.PACKAGE_STATEMENT__PAC_NAME:
        return getPacName();
    }
