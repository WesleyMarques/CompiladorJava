 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Class_declarationImpl#getModifiers <em>Modifiers</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Class_declarationImpl#getClassName <em>Class Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Class_declarationImpl#getClassHerdada <em>Class Herdada</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Class_declarationImpl#getInterfaceImplementada <em>Interface Implementada</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Class_declarationImpl#getInterfacesImplementadas <em>Interfaces Implementadas</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Class_declarationImpl#getFieldsDeclaration <em>Fields Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Class_declarationImpl extends MinimalEObjectImpl.Container implements Class_declaration
{
  ...
  {
    return MyJavaPackage.Literals.CLASS_DECLARATION;
  }
  ...
  public EList<String> getModifiers()
  {
    if (modifiers == null)
    {
      modifiers = new EDataTypeEList<String>(String.class, this, MyJavaPackage.CLASS_DECLARATION__MODIFIERS);
    }
    return modifiers;
  }
  ...
  public void setClassName(String newClassName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.CLASS_DECLARATION__CLASS_NAME, oldClassName, className));
  }
  ...
  public void setClassHerdada(String newClassHerdada)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.CLASS_DECLARATION__CLASS_HERDADA, oldClassHerdada, classHerdada));
  }
  ...
  public void setInterfaceImplementada(String newInterfaceImplementada)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.CLASS_DECLARATION__INTERFACE_IMPLEMENTADA, oldInterfaceImplementada, interfaceImplementada));
  }
  ...
  public EList<String> getInterfacesImplementadas()
  {
    ...
    {
      interfacesImplementadas = new EDataTypeEList<String>(String.class, this, MyJavaPackage.CLASS_DECLARATION__INTERFACES_IMPLEMENTADAS);
    }
  ...
  public EList<Field_declaration> getFieldsDeclaration()
  {
    ...
    {
      fieldsDeclaration = new EObjectContainmentEList<Field_declaration>(Field_declaration.class, this, MyJavaPackage.CLASS_DECLARATION__FIELDS_DECLARATION);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyJavaPackage.CLASS_DECLARATION__FIELDS_DECLARATION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyJavaPackage.CLASS_DECLARATION__MODIFIERS:
        return getModifiers();
      case MyJavaPackage.CLASS_DECLARATION__CLASS_NAME:
        return getClassName();
      case MyJavaPackage.CLASS_DECLARATION__CLASS_HERDADA:
        return getClassHerdada();
      case MyJavaPackage.CLASS_DECLARATION__INTERFACE_IMPLEMENTADA:
        return getInterfaceImplementada();
      case MyJavaPackage.CLASS_DECLARATION__INTERFACES_IMPLEMENTADAS:
