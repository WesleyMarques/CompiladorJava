 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Interface_declarationImpl#getModifiers <em>Modifiers</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Interface_declarationImpl#getInterfaceName <em>Interface Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Interface_declarationImpl#getInterfaceHerdada <em>Interface Herdada</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Interface_declarationImpl#getInterfacesHerdadas <em>Interfaces Herdadas</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Interface_declarationImpl extends MinimalEObjectImpl.Container implements Interface_declaration
{
  ...
  {
    return MyJavaPackage.Literals.INTERFACE_DECLARATION;
  }
  ...
  public EList<String> getModifiers()
  {
    if (modifiers == null)
    {
      modifiers = new EDataTypeEList<String>(String.class, this, MyJavaPackage.INTERFACE_DECLARATION__MODIFIERS);
    }
    return modifiers;
  }
  ...
  public void setInterfaceName(String newInterfaceName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.INTERFACE_DECLARATION__INTERFACE_NAME, oldInterfaceName, interfaceName));
  }
  ...
  public void setInterfaceHerdada(String newInterfaceHerdada)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.INTERFACE_DECLARATION__INTERFACE_HERDADA, oldInterfaceHerdada, interfaceHerdada));
  }
  ...
  public EList<String> getInterfacesHerdadas()
  {
    ...
    {
      interfacesHerdadas = new EDataTypeEList<String>(String.class, this, MyJavaPackage.INTERFACE_DECLARATION__INTERFACES_HERDADAS);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyJavaPackage.INTERFACE_DECLARATION__MODIFIERS:
        return getModifiers();
      case MyJavaPackage.INTERFACE_DECLARATION__INTERFACE_NAME:
        return getInterfaceName();
      case MyJavaPackage.INTERFACE_DECLARATION__INTERFACE_HERDADA:
        return getInterfaceHerdada();
      case MyJavaPackage.INTERFACE_DECLARATION__INTERFACES_HERDADAS:
