 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.Package_statement#getPacName <em>Pac Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getPackage_statement()
 * @model
 * @generated
 */
public interface Package_statement extends EObject
{
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getPackage_statement_PacName()
   * @model
   * @generated
   */
  String getPacName();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Package_statement#getPacName <em>Pac Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
