 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Static_initializerImpl#getStatic <em>Static</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Static_initializerImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Static_initializerImpl extends MinimalEObjectImpl.Container implements Static_initializer
{
  ...
  {
    return MyJavaPackage.Literals.STATIC_INITIALIZER;
  }
  ...
  public void setStatic(String newStatic)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.STATIC_INITIALIZER__STATIC, oldStatic, static_));
  }
  ...
  public NotificationChain basicSetName(Statement_block newName, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.STATIC_INITIALIZER__NAME, oldName, newName);
  ...
  public void setName(Statement_block newName)
  {
    if (newName != name)
    {
      ...
      if (name != null)
        msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.STATIC_INITIALIZER__NAME, null, msgs);
      if (newName != null)
        msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.STATIC_INITIALIZER__NAME, null, msgs);
      msgs = basicSetName(newName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.STATIC_INITIALIZER__NAME, newName, newName));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyJavaPackage.STATIC_INITIALIZER__NAME:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyJavaPackage.STATIC_INITIALIZER__STATIC:
        return getStatic();
      case MyJavaPackage.STATIC_INITIALIZER__NAME:
        return getName();
    }
