 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.Method_declaration#getModifiersMethod <em>Modifiers Method</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Method_declaration#getTypeMethod <em>Type Method</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Method_declaration#getNameMethod <em>Name Method</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Method_declaration#getLParen <em>LParen</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Method_declaration#getParameterListMethod <em>Parameter List Method</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Method_declaration#getRparent <em>Rparent</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Method_declaration#getStatementMethod <em>Statement Method</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Method_declaration#getDebug <em>Debug</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getMethod_declaration()
 * @model
 * @generated
 */
public interface Method_declaration extends EObject
{
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getMethod_declaration_ModifiersMethod()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getMethod_declaration_TypeMethod()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Method_declaration#getTypeMethod <em>Type Method</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getMethod_declaration_NameMethod()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Method_declaration#getNameMethod <em>Name Method</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getMethod_declaration_LParen()
   * @model
   * @generated
   */
  String getLParen();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Method_declaration#getLParen <em>LParen</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getMethod_declaration_ParameterListMethod()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Method_declaration#getParameterListMethod <em>Parameter List Method</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getMethod_declaration_Rparent()
   * @model
   * @generated
   */
  String getRparent();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Method_declaration#getRparent <em>Rparent</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getMethod_declaration_StatementMethod()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Method_declaration#getStatementMethod <em>Statement Method</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setDebug(String)
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getMethod_declaration_Debug()
   * @model
   * @generated
   */
  String getDebug();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Method_declaration#getDebug <em>Debug</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
