 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Method_declarationImpl#getModifiersMethod <em>Modifiers Method</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Method_declarationImpl#getTypeMethod <em>Type Method</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Method_declarationImpl#getNameMethod <em>Name Method</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Method_declarationImpl#getLParen <em>LParen</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Method_declarationImpl#getParameterListMethod <em>Parameter List Method</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Method_declarationImpl#getRparent <em>Rparent</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Method_declarationImpl#getStatementMethod <em>Statement Method</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Method_declarationImpl#getDebug <em>Debug</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Method_declarationImpl extends MinimalEObjectImpl.Container implements Method_declaration
{
  ...
  {
    return MyJavaPackage.Literals.METHOD_DECLARATION;
  }
  ...
  public EList<String> getModifiersMethod()
  {
    ...
    {
      modifiersMethod = new EDataTypeEList<String>(String.class, this, MyJavaPackage.METHOD_DECLARATION__MODIFIERS_METHOD);
    }
  ...
  public NotificationChain basicSetTypeMethod(Type newTypeMethod, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.METHOD_DECLARATION__TYPE_METHOD, oldTypeMethod, newTypeMethod);
  ...
  public void setTypeMethod(Type newTypeMethod)
  {
    if (newTypeMethod != typeMethod)
    {
      ...
      if (typeMethod != null)
        msgs = ((InternalEObject)typeMethod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.METHOD_DECLARATION__TYPE_METHOD, null, msgs);
      if (newTypeMethod != null)
        msgs = ((InternalEObject)newTypeMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.METHOD_DECLARATION__TYPE_METHOD, null, msgs);
      msgs = basicSetTypeMethod(newTypeMethod, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.METHOD_DECLARATION__TYPE_METHOD, newTypeMethod, newTypeMethod));
  }
  ...
  public void setNameMethod(String newNameMethod)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.METHOD_DECLARATION__NAME_METHOD, oldNameMethod, nameMethod));
  }
  ...
  public void setLParen(String newLParen)
  {
    ...
    lParen = newLParen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.METHOD_DECLARATION__LPAREN, oldLParen, lParen));
  }
  ...
  public NotificationChain basicSetParameterListMethod(Parameter_list newParameterListMethod, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.METHOD_DECLARATION__PARAMETER_LIST_METHOD, oldParameterListMethod, newParameterListMethod);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setParameterListMethod(Parameter_list newParameterListMethod)
  {
    if (newParameterListMethod != parameterListMethod)
    {
      ...
      if (parameterListMethod != null)
        msgs = ((InternalEObject)parameterListMethod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.METHOD_DECLARATION__PARAMETER_LIST_METHOD, null, msgs);
      if (newParameterListMethod != null)
        msgs = ((InternalEObject)newParameterListMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.METHOD_DECLARATION__PARAMETER_LIST_METHOD, null, msgs);
      msgs = basicSetParameterListMethod(newParameterListMethod, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.METHOD_DECLARATION__PARAMETER_LIST_METHOD, newParameterListMethod, newParameterListMethod));
  }
  ...
  public void setRparent(String newRparent)
  {
    ...
    rparent = newRparent;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.METHOD_DECLARATION__RPARENT, oldRparent, rparent));
  }
  ...
  public NotificationChain basicSetStatementMethod(Statement_block newStatementMethod, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.METHOD_DECLARATION__STATEMENT_METHOD, oldStatementMethod, newStatementMethod);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStatementMethod(Statement_block newStatementMethod)
  {
    if (newStatementMethod != statementMethod)
    {
      ...
      if (statementMethod != null)
        msgs = ((InternalEObject)statementMethod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.METHOD_DECLARATION__STATEMENT_METHOD, null, msgs);
      if (newStatementMethod != null)
        msgs = ((InternalEObject)newStatementMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.METHOD_DECLARATION__STATEMENT_METHOD, null, msgs);
      msgs = basicSetStatementMethod(newStatementMethod, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.METHOD_DECLARATION__STATEMENT_METHOD, newStatementMethod, newStatementMethod));
  }
  ...
  public void setDebug(String newDebug)
  {
    ...
    debug = newDebug;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.METHOD_DECLARATION__DEBUG, oldDebug, debug));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyJavaPackage.METHOD_DECLARATION__TYPE_METHOD:
        return basicSetTypeMethod(null, msgs);
      case MyJavaPackage.METHOD_DECLARATION__PARAMETER_LIST_METHOD:
        return basicSetParameterListMethod(null, msgs);
      case MyJavaPackage.METHOD_DECLARATION__STATEMENT_METHOD:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyJavaPackage.METHOD_DECLARATION__MODIFIERS_METHOD:
        return getModifiersMethod();
      case MyJavaPackage.METHOD_DECLARATION__TYPE_METHOD:
        return getTypeMethod();
      case MyJavaPackage.METHOD_DECLARATION__NAME_METHOD:
        return getNameMethod();
      case MyJavaPackage.METHOD_DECLARATION__LPAREN:
        return getLParen();
      case MyJavaPackage.METHOD_DECLARATION__PARAMETER_LIST_METHOD:
        return getParameterListMethod();
      case MyJavaPackage.METHOD_DECLARATION__RPARENT:
        return getRparent();
      case MyJavaPackage.METHOD_DECLARATION__STATEMENT_METHOD:
        return getStatementMethod();
      case MyJavaPackage.METHOD_DECLARATION__DEBUG:
        return getDebug();
    }
