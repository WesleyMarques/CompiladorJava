 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Type_declarationImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Type_declarationImpl#getClassDec <em>Class Dec</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Type_declarationImpl#getInterfaceDec <em>Interface Dec</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Type_declarationImpl extends MinimalEObjectImpl.Container implements Type_declaration
{
  ...
  {
    return MyJavaPackage.Literals.TYPE_DECLARATION;
  }
  ...
  public void setComment(String newComment)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.TYPE_DECLARATION__COMMENT, oldComment, comment));
  }
  ...
  public NotificationChain basicSetClassDec(Class_declaration newClassDec, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.TYPE_DECLARATION__CLASS_DEC, oldClassDec, newClassDec);
  ...
  public void setClassDec(Class_declaration newClassDec)
  {
    if (newClassDec != classDec)
    {
      ...
      if (classDec != null)
        msgs = ((InternalEObject)classDec).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.TYPE_DECLARATION__CLASS_DEC, null, msgs);
      if (newClassDec != null)
        msgs = ((InternalEObject)newClassDec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.TYPE_DECLARATION__CLASS_DEC, null, msgs);
      msgs = basicSetClassDec(newClassDec, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.TYPE_DECLARATION__CLASS_DEC, newClassDec, newClassDec));
  }
  ...
  public NotificationChain basicSetInterfaceDec(Interface_declaration newInterfaceDec, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.TYPE_DECLARATION__INTERFACE_DEC, oldInterfaceDec, newInterfaceDec);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setInterfaceDec(Interface_declaration newInterfaceDec)
  {
    if (newInterfaceDec != interfaceDec)
    {
      ...
      if (interfaceDec != null)
        msgs = ((InternalEObject)interfaceDec).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.TYPE_DECLARATION__INTERFACE_DEC, null, msgs);
      if (newInterfaceDec != null)
        msgs = ((InternalEObject)newInterfaceDec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.TYPE_DECLARATION__INTERFACE_DEC, null, msgs);
      msgs = basicSetInterfaceDec(newInterfaceDec, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.TYPE_DECLARATION__INTERFACE_DEC, newInterfaceDec, newInterfaceDec));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyJavaPackage.TYPE_DECLARATION__CLASS_DEC:
        return basicSetClassDec(null, msgs);
      case MyJavaPackage.TYPE_DECLARATION__INTERFACE_DEC:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyJavaPackage.TYPE_DECLARATION__COMMENT:
        return getComment();
      case MyJavaPackage.TYPE_DECLARATION__CLASS_DEC:
        return getClassDec();
      case MyJavaPackage.TYPE_DECLARATION__INTERFACE_DEC:
