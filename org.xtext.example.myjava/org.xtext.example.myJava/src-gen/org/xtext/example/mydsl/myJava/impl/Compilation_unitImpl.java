 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Compilation_unitImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Compilation_unitImpl#getImports <em>Imports</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Compilation_unitImpl#getTypeDeclarations <em>Type Declarations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Compilation_unitImpl extends MinimalEObjectImpl.Container implements Compilation_unit
{
  ...
  {
    return MyJavaPackage.Literals.COMPILATION_UNIT;
  }
  ...
  public NotificationChain basicSetName(Package_statement newName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.COMPILATION_UNIT__NAME, oldName, newName);
  ...
  public void setName(Package_statement newName)
  {
    if (newName != name)
    {
      ...
      if (name != null)
        msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.COMPILATION_UNIT__NAME, null, msgs);
      if (newName != null)
        msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.COMPILATION_UNIT__NAME, null, msgs);
      msgs = basicSetName(newName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.COMPILATION_UNIT__NAME, newName, newName));
  }
  ...
  public EList<Import_statement> getImports()
  {
    if (imports == null)
    {
      imports = new EObjectContainmentEList<Import_statement>(Import_statement.class, this, MyJavaPackage.COMPILATION_UNIT__IMPORTS);
    }
    return imports;
  }
  ...
  public EList<Type_declaration> getTypeDeclarations()
  {
    ...
    {
      typeDeclarations = new EObjectContainmentEList<Type_declaration>(Type_declaration.class, this, MyJavaPackage.COMPILATION_UNIT__TYPE_DECLARATIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyJavaPackage.COMPILATION_UNIT__NAME:
        return basicSetName(null, msgs);
      case MyJavaPackage.COMPILATION_UNIT__IMPORTS:
        return ((InternalEList<?>)getImports()).basicRemove(otherEnd, msgs);
      case MyJavaPackage.COMPILATION_UNIT__TYPE_DECLARATIONS:
