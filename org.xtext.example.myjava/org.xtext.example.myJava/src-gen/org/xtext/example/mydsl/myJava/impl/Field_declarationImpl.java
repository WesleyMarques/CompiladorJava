 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Field_declarationImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Field_declarationImpl#getVariableDeclaration <em>Variable Declaration</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Field_declarationImpl#getContructorName <em>Contructor Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Field_declarationImpl#getMethodName <em>Method Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Field_declarationImpl#getStaticinitializer <em>Staticinitializer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Field_declarationImpl extends MinimalEObjectImpl.Container implements Field_declaration
{
  ...
  {
    return MyJavaPackage.Literals.FIELD_DECLARATION;
  }
  ...
  public void setComment(String newComment)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.FIELD_DECLARATION__COMMENT, oldComment, comment));
  }
  ...
  public NotificationChain basicSetVariableDeclaration(Variable_declaration newVariableDeclaration, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.FIELD_DECLARATION__VARIABLE_DECLARATION, oldVariableDeclaration, newVariableDeclaration);
  ...
  public void setVariableDeclaration(Variable_declaration newVariableDeclaration)
  {
    if (newVariableDeclaration != variableDeclaration)
    {
      ...
      if (variableDeclaration != null)
        msgs = ((InternalEObject)variableDeclaration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.FIELD_DECLARATION__VARIABLE_DECLARATION, null, msgs);
      if (newVariableDeclaration != null)
        msgs = ((InternalEObject)newVariableDeclaration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.FIELD_DECLARATION__VARIABLE_DECLARATION, null, msgs);
      msgs = basicSetVariableDeclaration(newVariableDeclaration, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.FIELD_DECLARATION__VARIABLE_DECLARATION, newVariableDeclaration, newVariableDeclaration));
  }
  ...
  public NotificationChain basicSetContructorName(Constructor_declaration newContructorName, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.FIELD_DECLARATION__CONTRUCTOR_NAME, oldContructorName, newContructorName);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setContructorName(Constructor_declaration newContructorName)
  {
    if (newContructorName != contructorName)
    {
      ...
      if (contructorName != null)
        msgs = ((InternalEObject)contructorName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.FIELD_DECLARATION__CONTRUCTOR_NAME, null, msgs);
      if (newContructorName != null)
        msgs = ((InternalEObject)newContructorName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.FIELD_DECLARATION__CONTRUCTOR_NAME, null, msgs);
      msgs = basicSetContructorName(newContructorName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.FIELD_DECLARATION__CONTRUCTOR_NAME, newContructorName, newContructorName));
  }
  ...
  public NotificationChain basicSetMethodName(Method_declaration newMethodName, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.FIELD_DECLARATION__METHOD_NAME, oldMethodName, newMethodName);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setMethodName(Method_declaration newMethodName)
  {
    if (newMethodName != methodName)
    {
      NotificationChain msgs = null;
      if (methodName != null)
        msgs = ((InternalEObject)methodName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.FIELD_DECLARATION__METHOD_NAME, null, msgs);
      if (newMethodName != null)
        msgs = ((InternalEObject)newMethodName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.FIELD_DECLARATION__METHOD_NAME, null, msgs);
      msgs = basicSetMethodName(newMethodName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.FIELD_DECLARATION__METHOD_NAME, newMethodName, newMethodName));
  }
  ...
  public NotificationChain basicSetStaticinitializer(Static_initializer newStaticinitializer, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.FIELD_DECLARATION__STATICINITIALIZER, oldStaticinitializer, newStaticinitializer);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStaticinitializer(Static_initializer newStaticinitializer)
  {
    if (newStaticinitializer != staticinitializer)
    {
      ...
      if (staticinitializer != null)
        msgs = ((InternalEObject)staticinitializer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.FIELD_DECLARATION__STATICINITIALIZER, null, msgs);
      if (newStaticinitializer != null)
        msgs = ((InternalEObject)newStaticinitializer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.FIELD_DECLARATION__STATICINITIALIZER, null, msgs);
      msgs = basicSetStaticinitializer(newStaticinitializer, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.FIELD_DECLARATION__STATICINITIALIZER, newStaticinitializer, newStaticinitializer));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyJavaPackage.FIELD_DECLARATION__VARIABLE_DECLARATION:
        return basicSetVariableDeclaration(null, msgs);
      case MyJavaPackage.FIELD_DECLARATION__CONTRUCTOR_NAME:
        return basicSetContructorName(null, msgs);
      case MyJavaPackage.FIELD_DECLARATION__METHOD_NAME:
        return basicSetMethodName(null, msgs);
      case MyJavaPackage.FIELD_DECLARATION__STATICINITIALIZER:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyJavaPackage.FIELD_DECLARATION__COMMENT:
        return getComment();
      case MyJavaPackage.FIELD_DECLARATION__VARIABLE_DECLARATION:
