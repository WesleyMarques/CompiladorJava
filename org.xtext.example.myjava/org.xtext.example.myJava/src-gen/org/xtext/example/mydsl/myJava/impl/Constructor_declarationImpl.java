 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Constructor_declarationImpl#getModifiersConstructor <em>Modifiers Constructor</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Constructor_declarationImpl#getNameConstructor <em>Name Constructor</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Constructor_declarationImpl#getLParen <em>LParen</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Constructor_declarationImpl#getParameterListConstructor <em>Parameter List Constructor</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Constructor_declarationImpl#getRparent <em>Rparent</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.Constructor_declarationImpl#getStatementConstructor <em>Statement Constructor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Constructor_declarationImpl extends MinimalEObjectImpl.Container implements Constructor_declaration
{
  ...
  {
    return MyJavaPackage.Literals.CONSTRUCTOR_DECLARATION;
  }
  ...
  public EList<String> getModifiersConstructor()
  {
    ...
    {
      modifiersConstructor = new EDataTypeEList<String>(String.class, this, MyJavaPackage.CONSTRUCTOR_DECLARATION__MODIFIERS_CONSTRUCTOR);
    }
  ...
  public void setNameConstructor(String newNameConstructor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.CONSTRUCTOR_DECLARATION__NAME_CONSTRUCTOR, oldNameConstructor, nameConstructor));
  }
  ...
  public void setLParen(String newLParen)
  {
    ...
    lParen = newLParen;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.CONSTRUCTOR_DECLARATION__LPAREN, oldLParen, lParen));
  }
  ...
  public NotificationChain basicSetParameterListConstructor(Parameter_list newParameterListConstructor, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.CONSTRUCTOR_DECLARATION__PARAMETER_LIST_CONSTRUCTOR, oldParameterListConstructor, newParameterListConstructor);
  ...
  public void setParameterListConstructor(Parameter_list newParameterListConstructor)
  {
    if (newParameterListConstructor != parameterListConstructor)
    {
      ...
      if (parameterListConstructor != null)
        msgs = ((InternalEObject)parameterListConstructor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.CONSTRUCTOR_DECLARATION__PARAMETER_LIST_CONSTRUCTOR, null, msgs);
      if (newParameterListConstructor != null)
        msgs = ((InternalEObject)newParameterListConstructor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.CONSTRUCTOR_DECLARATION__PARAMETER_LIST_CONSTRUCTOR, null, msgs);
      msgs = basicSetParameterListConstructor(newParameterListConstructor, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.CONSTRUCTOR_DECLARATION__PARAMETER_LIST_CONSTRUCTOR, newParameterListConstructor, newParameterListConstructor));
  }
  ...
  public void setRparent(String newRparent)
  {
    ...
    rparent = newRparent;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.CONSTRUCTOR_DECLARATION__RPARENT, oldRparent, rparent));
  }
  ...
  public NotificationChain basicSetStatementConstructor(Statement_block newStatementConstructor, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.CONSTRUCTOR_DECLARATION__STATEMENT_CONSTRUCTOR, oldStatementConstructor, newStatementConstructor);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStatementConstructor(Statement_block newStatementConstructor)
  {
    if (newStatementConstructor != statementConstructor)
    {
      ...
      if (statementConstructor != null)
        msgs = ((InternalEObject)statementConstructor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.CONSTRUCTOR_DECLARATION__STATEMENT_CONSTRUCTOR, null, msgs);
      if (newStatementConstructor != null)
        msgs = ((InternalEObject)newStatementConstructor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.CONSTRUCTOR_DECLARATION__STATEMENT_CONSTRUCTOR, null, msgs);
      msgs = basicSetStatementConstructor(newStatementConstructor, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.CONSTRUCTOR_DECLARATION__STATEMENT_CONSTRUCTOR, newStatementConstructor, newStatementConstructor));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyJavaPackage.CONSTRUCTOR_DECLARATION__PARAMETER_LIST_CONSTRUCTOR:
        return basicSetParameterListConstructor(null, msgs);
      case MyJavaPackage.CONSTRUCTOR_DECLARATION__STATEMENT_CONSTRUCTOR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyJavaPackage.CONSTRUCTOR_DECLARATION__MODIFIERS_CONSTRUCTOR:
        return getModifiersConstructor();
      case MyJavaPackage.CONSTRUCTOR_DECLARATION__NAME_CONSTRUCTOR:
        return getNameConstructor();
      case MyJavaPackage.CONSTRUCTOR_DECLARATION__LPAREN:
        return getLParen();
      case MyJavaPackage.CONSTRUCTOR_DECLARATION__PARAMETER_LIST_CONSTRUCTOR:
        return getParameterListConstructor();
      case MyJavaPackage.CONSTRUCTOR_DECLARATION__RPARENT:
        return getRparent();
      case MyJavaPackage.CONSTRUCTOR_DECLARATION__STATEMENT_CONSTRUCTOR:
