 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.While_StatementImpl#getRparent <em>Rparent</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.impl.While_StatementImpl#getWhileStatement <em>While Statement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class While_StatementImpl extends MinimalEObjectImpl.Container implements While_Statement
{
  ...
  {
    return MyJavaPackage.Literals.WHILE_STATEMENT;
  }
  ...
  public void setRparent(String newRparent)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.WHILE_STATEMENT__RPARENT, oldRparent, rparent));
  }
  ...
  public NotificationChain basicSetWhileStatement(Statement newWhileStatement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyJavaPackage.WHILE_STATEMENT__WHILE_STATEMENT, oldWhileStatement, newWhileStatement);
  ...
  public void setWhileStatement(Statement newWhileStatement)
  {
    if (newWhileStatement != whileStatement)
    {
      ...
      if (whileStatement != null)
        msgs = ((InternalEObject)whileStatement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.WHILE_STATEMENT__WHILE_STATEMENT, null, msgs);
      if (newWhileStatement != null)
        msgs = ((InternalEObject)newWhileStatement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyJavaPackage.WHILE_STATEMENT__WHILE_STATEMENT, null, msgs);
      msgs = basicSetWhileStatement(newWhileStatement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyJavaPackage.WHILE_STATEMENT__WHILE_STATEMENT, newWhileStatement, newWhileStatement));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyJavaPackage.WHILE_STATEMENT__WHILE_STATEMENT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyJavaPackage.WHILE_STATEMENT__RPARENT:
        return getRparent();
      case MyJavaPackage.WHILE_STATEMENT__WHILE_STATEMENT:
