 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myJava.Constructor_declaration#getModifiersConstructor <em>Modifiers Constructor</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Constructor_declaration#getNameConstructor <em>Name Constructor</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Constructor_declaration#getLParen <em>LParen</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Constructor_declaration#getParameterListConstructor <em>Parameter List Constructor</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Constructor_declaration#getRparent <em>Rparent</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myJava.Constructor_declaration#getStatementConstructor <em>Statement Constructor</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getConstructor_declaration()
 * @model
 * @generated
 */
public interface Constructor_declaration extends EObject
{
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getConstructor_declaration_ModifiersConstructor()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getConstructor_declaration_NameConstructor()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Constructor_declaration#getNameConstructor <em>Name Constructor</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getConstructor_declaration_LParen()
   * @model
   * @generated
   */
  String getLParen();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Constructor_declaration#getLParen <em>LParen</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getConstructor_declaration_ParameterListConstructor()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Constructor_declaration#getParameterListConstructor <em>Parameter List Constructor</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getConstructor_declaration_Rparent()
   * @model
   * @generated
   */
  String getRparent();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Constructor_declaration#getRparent <em>Rparent</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#getConstructor_declaration_StatementConstructor()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myJava.Constructor_declaration#getStatementConstructor <em>Statement Constructor</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
