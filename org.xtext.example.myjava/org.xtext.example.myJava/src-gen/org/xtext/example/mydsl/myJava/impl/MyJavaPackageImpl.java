...
import org.xtext.example.mydsl.myJava.MyJavaFactory;
...
public class MyJavaPackageImpl extends EPackageImpl implements MyJavaPackage
{
   ...
   * @generated
   */
  private EClass numeric_Expression_lineEClass = null;
   ...
   * @see org.xtext.example.mydsl.myJava.MyJavaPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  {
    if (isInited) return (MyJavaPackage)EPackage.Registry.INSTANCE.getEPackage(MyJavaPackage.eNS_URI);

    // Obtain or create and register package
    MyJavaPackageImpl theMyJavaPackage = (MyJavaPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MyJavaPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MyJavaPackageImpl());
   ...
   * @generated
   */
  public EAttribute getExpression_LParen()
  {
   ...
   * @generated
   */
  public EAttribute getExpression_Rparent()
  {
   ...
   * @generated
   */
  public EAttribute getNumeric_Expression_UnaryOp()
  {
   ...
   * @generated
   */
  public EReference getNumeric_Expression_NumericExpressionLine()
  {
    return (EReference)numeric_ExpressionEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EClass getNumeric_Expression_line()
  {
    return numeric_Expression_lineEClass;
  }
   ...
   * @generated
   */
  public EAttribute getNumeric_Expression_line_Increment()
  {
    return (EAttribute)numeric_Expression_lineEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getNumeric_Expression_line_ExpressionLine()
  {
    return (EReference)numeric_Expression_lineEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EAttribute getNumeric_Expression_line_Op()
  {
    return (EAttribute)numeric_Expression_lineEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getNumeric_Expression_line_Expression()
  {
    return (EReference)numeric_Expression_lineEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EAttribute getExpression_line_LParen()
  {
   ...
   * @generated
   */
  public EAttribute getExpression_line_Rparent()
  {
    return (EAttribute)expression_lineEClass.getEStructuralFeatures().get(1);
  }
  ...
  {
    return (EAttribute)switch_statementEClass.getEStructuralFeatures().get(1);
  }
  ...
  {
    return (EAttribute)while_StatementEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(expressionEClass, EXPRESSION__LPAREN);
    createEAttribute(expressionEClass, EXPRESSION__RPARENT);
    ...
    createEAttribute(numeric_ExpressionEClass, NUMERIC_EXPRESSION__UNARY_OP);
    createEReference(numeric_ExpressionEClass, NUMERIC_EXPRESSION__EXPRESSION);
    createEReference(numeric_ExpressionEClass, NUMERIC_EXPRESSION__NUMERIC_EXPRESSION_LINE);

    numeric_Expression_lineEClass = createEClass(NUMERIC_EXPRESSION_LINE);
    createEAttribute(numeric_Expression_lineEClass, NUMERIC_EXPRESSION_LINE__INCREMENT);
    createEReference(numeric_Expression_lineEClass, NUMERIC_EXPRESSION_LINE__EXPRESSION_LINE);
    createEAttribute(numeric_Expression_lineEClass, NUMERIC_EXPRESSION_LINE__OP);
    createEReference(numeric_Expression_lineEClass, NUMERIC_EXPRESSION_LINE__EXPRESSION);

    expression_lineEClass = createEClass(EXPRESSION_LINE);
    createEAttribute(expression_lineEClass, EXPRESSION_LINE__LPAREN);
    createEAttribute(expression_lineEClass, EXPRESSION_LINE__RPARENT);
  ...
  public void initializePackageContents()
  {
    ...
    expression_lineEClass.getESuperTypes().add(this.getNumeric_Expression_line());
    ...
    initEAttribute(getExpression_LParen(), ecorePackage.getEString(), "lParen", null, 0, 1, Expression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getExpression_Rparent(), ecorePackage.getEString(), "rparent", null, 0, 1, Expression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getNumeric_Expression_UnaryOp(), ecorePackage.getEString(), "unaryOp", null, 0, 1, Numeric_Expression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getNumeric_Expression_NumericExpressionLine(), this.getNumeric_Expression_line(), null, "numericExpressionLine", null, 0, 1, Numeric_Expression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(numeric_Expression_lineEClass, Numeric_Expression_line.class, "Numeric_Expression_line", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getNumeric_Expression_line_Increment(), ecorePackage.getEString(), "increment", null, 0, 1, Numeric_Expression_line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getNumeric_Expression_line_ExpressionLine(), this.getExpression_line(), null, "expressionLine", null, 0, 1, Numeric_Expression_line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getNumeric_Expression_line_Op(), ecorePackage.getEString(), "op", null, 0, 1, Numeric_Expression_line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getNumeric_Expression_line_Expression(), ecorePackage.getEObject(), null, "expression", null, 0, 1, Numeric_Expression_line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getExpression_line_LParen(), ecorePackage.getEString(), "lParen", null, 0, 1, Expression_line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getExpression_line_Rparent(), ecorePackage.getEString(), "rparent", null, 0, 1, Expression_line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
